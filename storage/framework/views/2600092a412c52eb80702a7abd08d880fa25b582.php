    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>/admin">AQMS v0.1</a>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
								...
								<?php if(isset($_COOKIE['cookie_ngayau_user']) && $_COOKIE['cookie_ngayau_user']!=''): ?>
									<h5 class="mb-0 text-white nav-user-name"><?php echo e($_COOKIE['cookie_ngayau_user']); ?></h5>
								<?php else: ?>
									<h5 class="mb-0 text-white nav-user-name"><?php echo e(Session::get('user_ngayauv2.0')); ?></h5>
								<?php endif; ?>
	
                                    
                                    <span class="status"></span><span class="ml-2">Online</span>
                                </div>
                                <a class="dropdown-item" href="<?php echo e(url('/')); ?>/admin/logout"><i class="fas fa-power-off mr-2"></i>Log Out</a>
								<a class="dropdown-item" href="<?php echo e(url('/')); ?>/admin/content/change-password"><i class="fas fa-key"></i> Change Password</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="<?php echo e(url('/')); ?>/admin"><i class="fa fa-fw fa-user-circle"></i>Home <span class="badge badge-success">6</span></a>
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
											...
											<a class="nav-link" href="<?php echo e(url('/')); ?>/admin/content/real-time-data">Real Time<span class="badge badge-secondary">New</span></a>
                                        </li>
										<li class="nav-item">
                                       
											<a class="nav-link" href="<?php echo e(url('/')); ?>/admin/content/log-data">Log<span class="badge badge-secondary">New</span></a>
                                        </li>
							...
							<?php if(isset($_COOKIE['cookie_ngayau_admin'])): ?>
									<?php if($_COOKIE['cookie_ngayau_admin']==1): ?>
										<li class="nav-item">
											...
											<div id="submenu-5" class="collapse submenu" style="">
												<ul class="nav flex-column">
													<li class="nav-item">											   
														<a class="nav-link" href="<?php echo e(url('/')); ?>/admin/content/account">Account<span class="badge badge-secondary">New</span></a>
													</li>
													<li class="nav-item">
												   
														<a class="nav-link" href="<?php echo e(url('/')); ?>/admin/content/device">Device<span class="badge badge-secondary">New</span></a>
													</li>
									...
									<?php endif; ?>
							<?php else: ?>
									<?php if(Session::get('admin_ngayauv2.0')==1): ?>
										<li class="nav-item">
											<a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fa fa-fw fa-cog"></i>Setting</a>
											<div id="submenu-5" class="collapse submenu" style="">
												<ul class="nav flex-column">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>/admin" class="breadcrumb-link">Home</a></li>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$('#table4 tbody').on( 'click', 'button', function () {
				...
				//$("#valsite18").attr("src","<?php echo e(url('/')); ?>/storage/app/"+dataku[1]);			
			...
			$('#table4 tbody').on( 'click', 'button', function () {
				...
				$("#rfr").click(function(){
					...
					$.ajax({
					   ...
					   url:"<?php echo e(route('ajaxRequestData.post')); ?>",
			...
			$("#t").click(function () {
				...
				$.ajax({
				   ...
				   url:"<?php echo e(route('ajaxRequestAcc.post')); ?>",
			...
			$("#u").click(function () {
				...
				$.ajax({
				   ...
				   url:"<?php echo e(route('ajaxRequestActivate.post')); ?>",
			...
			$("#v").click(function () {
				...
				$.ajax({
				   ...
				   url:"<?php echo e(route('ajaxRequestDeactivate.post')); ?>",
...
</html><?php /**PATH /home/u558940034/domains/ppihyderabad.com/public_html/aqms/resources/views/backend/master.blade.php ENDPATH**/ ?>